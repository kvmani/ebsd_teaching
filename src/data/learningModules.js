...
export const learningModules = [
  {
    ...
    difficulty: 'Beginner',
    learningObjectives: ['Define what EBSD infers from patterns.', 'Connect patterns to orientation maps.', 'Recognize why data quality matters.'],
    topics: ['What EBSD infers', 'Orientation maps', 'Phase evidence', 'Grain boundaries', 'Texture', 'Pattern quality'],
    keyIdeas: ['EBSD is a SEM-based diffraction method.', 'Each scan pixel needs a usable Kikuchi pattern.', 'Orientation color is not chemistry by itself.', 'Poor acquisition can create misleading maps.', 'Quality and confidence-like evidence should be checked together.'],
    explanation: 'EBSD uses local diffraction patterns to infer maps of crystal orientation and, when the phase model and evidence support it, sometimes phase. This app keeps the chain visible: beam, sample, diffraction, detector pattern, indexing, and map.',
    ...
    quizQuestions: [
      q('intro-q1', 'multiple-choice', 'What does EBSD primarily infer at each scan pixel?', ['Surface height only', 'Crystal orientation and sometimes phase', 'Bulk temperature', 'Beam current'], 1, 'EBSD uses Kikuchi patterns to infer local crystal orientation and sometimes phase when the phase evidence is supported.'),
    ...
    miniExperiments: [{ label: 'Compare map quality', action: 'open-acquisition-balanced', text: 'Open Live Scan Acquisition and compare orientation and confidence-like views.' }],
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    learningObjectives: ['Describe the interaction volume.', 'Explain near-surface sensitivity.', 'Connect preparation quality to pattern quality.'],
    topics: ['Backscattered electrons', 'Elastic scattering', 'Inelastic scattering', 'Surface preparation', 'Near-surface sensitivity'],
    keyIdeas: ['Useful signal is dominated by the near surface.', 'Backscattered electrons carry diffraction information.', 'Damaged surface layers weaken bands.', 'The app volume is schematic.', 'Good preparation improves real EBSD reliability.'],
    ...
    misconception: 'EBSD should not be treated as a deep-bulk orientation measurement.',
    formulas: [],
    glossaryTerms: ['interaction volume', 'backscattered electron', 'pattern quality'],
    quizQuestions: [
      q('interaction-q1', 'multiple-choice', 'Why does sample preparation matter for EBSD?', ['It changes keyboard shortcuts', 'EBSD is near-surface sensitive', 'It removes the detector', 'It stops all scattering'], 1, 'The useful diffraction signal is dominated by electrons escaping from near the surface.'),
    ...
    simulatorLinks: ['Geometry + Pattern'],
    reflectionPrompts: [...commonReflectionPrompts, 'Reflect on why EBSD is near-surface sensitive.'],
    troubleshootingCards: []
  },
  {
    id: 'bragg',
  ...
  },
  {
    ...
    whyItMatters: 'Indexing software depends on band positions and quality. Weak or blurred bands reduce confidence-like evidence.',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    learningObjectives: ['Describe the simplified indexing workflow.', 'Explain how Hough-style band detection supports indexing.', 'Interpret confidence-like cues as decision strength, not proof.'],
    topics: ['Raw pattern', 'Background correction', 'Band detection', 'Hough transform', 'Band angle matching', 'Orientation solution', 'Confidence-like evidence and failure modes'],
    keyIdeas: ['Indexing starts with a raw Kikuchi pattern and background correction.', 'The Hough transform helps detect Kikuchi bands as line-like features; real projected band edges can be curved.', 'Detected band positions and angles are compared with theoretical crystal plane geometry.', 'The selected phase and detector calibration strongly affect the solution.', 'Good-looking EBSD maps can still be wrong.'],
    explanation: 'This module introduces the indexing pipeline step by step: raw pattern, background correction, band detection, Hough transform, band angle matching, orientation solution, and confidence-like checks.',
    ...
    misconception: 'Indexing is not magic, and confidence-like evidence is not the same thing as truth or brightness.',
    formulas: [],
    ...
    quizQuestions: [
      ...
      q('indexing-q2', 'choose-best', 'Best description of confidence-like indexing evidence:', ['A guarantee of truth', 'A decision-strength cue', 'A chemical assay', 'A sample tilt angle'], 1, 'Confidence-like evidence is useful, but it is not proof by itself.')
    ],
  ...
  },
  {
    ...
    estimatedTime: '18 min',
    difficulty: 'Intermediate',
    learningObjectives: ['Interpret IPF, quality, confidence-like, and unindexed maps.', 'Avoid confusing color with phase.', 'Use overlays to diagnose acquisition.'],
    topics: ['IPF orientation map', 'Pattern quality map', 'Confidence-like map', 'Unindexed pixels', 'Grain boundary overlay'],
    keyIdeas: ['IPF color encodes orientation.', 'Pattern quality shows pattern clarity.', 'Confidence-like cues show indexing decision strength.', 'Unindexed pixels show rejected solutions.', 'Boundaries often reduce quality.'],
    explanation: 'EBSD maps are different views of the same scan. A good interpretation compares orientation, quality, confidence-like evidence, and unindexed regions.',
    ...
    quizQuestions: [
      ...
      q('maps-q2', 'identify-misconception', 'Which is wrong?', ['Dark quality may mean weak patterns.', 'Confidence-like evidence should be inspected.', 'IPF color always means phase.', 'Unindexed pixels can reveal problems.'], 2, 'Phase identification needs more than IPF color.')
    ],
    miniExperiments: [{ label: 'Switch map views', action: 'acquisition-map-views', text: 'Open acquisition and switch orientation, quality, and confidence-like views.' }],
  ...
  },
  {
    ...
    keyIdeas: ['Pattern quality is evidence quality.', 'Bright is not always better.', 'Weak bands can produce misleading confidence-like cues.', 'Overlapping signals can create plausible wrong solutions.', 'Corrections should target the observed symptom.'],
  ...
  },
  {
    ...
    estimatedTime: '20 min',
    difficulty: 'Applied',
    learningObjectives: ['Explain why EBSD is near-surface sensitive.', 'Identify preparation artefacts.', 'Relate preparation quality to Kikuchi band sharpness.'],
  ...
  },
  {
    ...
    difficulty: 'Applied',
    learningObjectives: ['Connect sample prep, acquisition, indexing, confidence-like evidence, and maps.', 'Interpret map views together.', 'Use troubleshooting trees before changing settings randomly.'],
    topics: ['IPF maps', 'Phase maps', 'Band contrast', 'Grain boundaries', 'Twins', 'Deformation', 'Recrystallized grains', 'Confidence-like evidence and fit'],
    keyIdeas: ['No single EBSD view is enough.', 'IPF color is orientation, not chemistry.', 'Band contrast and confidence-like cues guide review.', 'Possible twins need crystallographic context.', 'Troubleshooting starts from symptoms.'],
    ...
    whyItMatters: 'EBSD interpretation is a chain of evidence. Students should learn to compare patterns, settings, confidence-like cues, and maps before making claims.',
    ...
    quizQuestions: [
      q('interpret-q1', 'multiple-choice', 'What should you compare before trusting an EBSD map?', ['Only IPF color', 'Pattern quality, confidence-like cues, phase context, and acquisition conditions', 'Only file size', 'Only the legend'], 1, 'Reliable interpretation compares several evidence views.'),
